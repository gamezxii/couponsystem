            ...
            <form action="" class="form-inlin justify-content-center">
                ...
                <div class="form-group">
                        ...
                        <select class="form-control" id="tpye-card-ac">โปรดเลือก
                                ...
                                <option value="4" >Farmberry Tour 150บาท</option>
                                <option value="5" >Farm Package1 200บาท</option>
                                <option value="6" >Farm Package2 350บาท</option>
                                <option value="7" >Farm Package3 500บาท</option>
                                <option value="8" >Farm Package1 160บาท(เด็ก)</option>
                                <option value="9" >Farm Package2 280บาท(เด็ก)</option>
                                <option value="10" >Farm Together</option>
                        </select>
                </div>

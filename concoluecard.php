    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="table-responsive">
                    ...
                    <table id="tbUser" border="1" class="table table-bordered" width="100%">
                    <thead>
                        <tr align="center">
                            <th >รหัสลูกค้า</th>
                            <th >ชื่อกรุ๊ป</th>
                        ...
                        <tfoot>
                        <tr>
                        <td align ="right"  colspan="11">รวม</td>
                        <td align ="right" id="total_sum">0.00</td>
                        </tr>
                        <tr>
                        <td align ="right"  colspan="2">โปรแกรมต้นไม้</td>
                        <td align="right" contenteditable="true" id="tree"></td>
                        </tr>
                        <tr>
                        <td align ="right"  colspan="2">สรุปการใช้บัตร</td>
                        <td align="right" contenteditable="true" id="usecard"></td>
                        </tr>
                        <tr>
                        <td align ="right"  colspan="2">Balance</td>
                        <td align="right" contenteditable="true" id="balance"></td>
                        </tr>
                        </tfoot>
                    </table>
            </div>
            ...
            <button  id="save" class="btn btn-lg btn-danger" type="button">บันทึก</button>
...
<script src="js/concoluecard.js"></script>
